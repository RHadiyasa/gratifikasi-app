...
export const pelaporanSections = [
  { id: "tujuan",     label: "Tujuan Fitur" },
  { id: "alur",       label: "Alur Pelaporan" },
  { id: "form",       label: "Pengisian Form" },
  { id: "konfirmasi", label: "Konfirmasi Laporan" },
  { id: "pdf",        label: "Hasil PDF" },
  { id: "status",     label: "Status Laporan" },
  { id: "hak",        label: "Hak Pelapor" },
