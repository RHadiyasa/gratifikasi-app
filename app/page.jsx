    ...
    <>
      <section className="relative flex flex-col min-h-screen items-center justify-center text-center w-full overflow-hidden">
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mt-6 z-10">
          <Link
            href="/lapor"
            className="flex items-center justify-center gap-2 px-6 py-3 text-white bg-violet-600 rounded-full font-semibold shadow-lg hover:bg-violet-700 transition-colors"
          >
        ...
        {/* Panah ke bawah */}
        <div className="absolute bottom-30 flex flex-col items-center animate-bounce">
          <ChevronDown size={40} className="text-violet-600 dark:text-violet-400" />
          <span className="text-sm text-default-600 mt-1">
            Scroll untuk fitur pelaporan
          </span>
        </div>
